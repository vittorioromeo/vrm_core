...
int main()
{
    ...
    auto movrl = make_overload([](int) { return 1; }, [](float) { return 2; },
        [](double) { return 3; },
    ...
    auto tpl_ov = make_overload([](int) { return 1; }, [](auto) { return 2; });
    ...
    auto single_templatized = make_overload([](auto) { return 0; });
