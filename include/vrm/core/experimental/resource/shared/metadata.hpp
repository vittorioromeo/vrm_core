    ...
    namespace resource
    {
        namespace impl
        {
            ...
            public:
                ...
                void increment_owner() noexcept { ++_owner_count; }
                ...
                void increment_weak() noexcept { ++_weak_count; }
                ...
                auto owner_count() const noexcept { return _owner_count; }

                auto weak_count() const noexcept { return _weak_count; }
                ...
                auto has_any_ref() const noexcept { return total_count() > 0; }
            };
        }
    }
}
