...
VRM_CORE_NAMESPACE
{
    namespace resource
    {
        namespace impl
        {
            ...
            shared_ref_counter::increment_owner() noexcept
            {
                access_metadata().increment_owner();
            }

            VRM_CORE_ALWAYS_INLINE void
            shared_ref_counter::decrement_owner() noexcept
            {
                access_metadata().decrement_owner();
            }

            VRM_CORE_ALWAYS_INLINE void
            shared_ref_counter::deallocate() noexcept
            {
                // TODO: total_count?
            ...
            void shared_ref_counter::deallocate_if_required(
                TF&& deleter) noexcept
            {
                if(!has_any_ref())
                {
            ...
            VRM_CORE_ALWAYS_INLINE void
            shared_ref_counter::decrement_weak() noexcept
            {
            ...
            VRM_CORE_ALWAYS_INLINE void
            shared_ref_counter::acquire_existing() noexcept
            {
                VRM_CORE_ASSERT(!is_null());
                increment_owner();
            }
            ...
            VRM_CORE_ALWAYS_INLINE void
            shared_ref_counter::increment_weak() noexcept
            {
